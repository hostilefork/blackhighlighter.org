...
*/
    ...
    $( "[for=compose]" ).on('click', function (event) {
    	$("#editor").blackhighlighter('option', 'mode', 'compose');
    	$('#compose').checked = true;
    	$('#compose').button("refresh");
    	$('#protect').checked = false;
    	$('#protect').button("refresh");
    	return true;
    });

    $( "[for=protect]" ).on('click', function (event) {
    	$("#editor").blackhighlighter('option', 'mode', 'protect');
    	$('#compose').checked = false;
    	$('#compose').button("refresh");
